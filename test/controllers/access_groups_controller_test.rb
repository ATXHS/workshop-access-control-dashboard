...
class AccessGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create access_group" do
    assert_difference('AccessGroup.count') do
      post access_groups_url, params: { access_group: { : @access_group., name: @access_group.name } }
    end
  ...
  test "should update access_group" do
    patch access_group_url(@access_group), params: { access_group: { : @access_group., name: @access_group.name } }
