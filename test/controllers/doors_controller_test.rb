...
class DoorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create door" do
    assert_difference('Door.count') do
      post doors_url, params: { door: { default_unlocked: @door.default_unlocked, name: @door.name } }
    end
  ...
  test "should update door" do
    patch door_url(@door), params: { door: { default_unlocked: @door.default_unlocked, name: @door.name } }
